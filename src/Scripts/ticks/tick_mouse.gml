...
if mouse_check_button_pressed(mb_left) {
    ...
    if mouse_collides(mouse_x, mouse_y, 224, 288, 306, 336) {
        ...
        if can_use(get_packed_16(item_viewing)) {
            ...
            tile_add(guimain, 128, 160, 16, 16, mouse_x + 16, mouse_y - 10, 6)
            tile_add(guimain, 144, 160, 16, 16, mouse_x + 32, mouse_y - 10, 6)
            tile_add(guimain, 160, 160, 16, 16, mouse_x + 48, mouse_y - 10, 6)
            tile_add(guimain, 176, 160, 16, 16, mouse_x + 64, mouse_y - 10, 6)
        }
